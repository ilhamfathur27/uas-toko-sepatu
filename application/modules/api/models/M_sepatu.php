...
class M_sepatu extends MY_Model{
  private $master_tabel = 'sepatu';
  private $kolom_search = array("a.nama");
  ...
  function list($limit = '',$offset = '',$and_where = array(),$or_where = array(),$search = ''){
    $select_query = "a.id_sepatu, a.nama, a.harga, a.deskripsi, a.stok, a.terjual, a.foto, a.created_at";
