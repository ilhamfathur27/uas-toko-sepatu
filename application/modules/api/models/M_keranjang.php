...
class M_keranjang extends MY_Model{
  ...
  function list($limit = '',$offset = '',$and_where = array(),$or_where = array(),$search = ''){
    $select_query = 'a.id_keranjang, a.id_user, a.id_sepatu, b.nama as nama_user, c.nama as nama_sepatu, c.foto, c.harga, a.kuantitas, (c.harga * a.kuantitas) as total_harga';
